...
-- Buffer
vim.api.nvim_set_keymap('n', '<A-,>', ':bprevious<CR>', opts)
vim.api.nvim_set_keymap('n', '<A-.>', ':bnext<CR>', opts)
...
vim.api.nvim_set_keymap('n', 'yp', [[<Cmd>let @+ = expand("%:p")<CR>]], opts)
vim.api.nvim_set_keymap('n', 'yP', [[<Cmd>let @+ = join([expand("%:p"), line(".")], ":")<CR>]], opts)
